...
namespace ListaDesejos.ViewModel
{
    public class DesejoViewModel : INotifyPropertyChanged
    {
        ...
        void ShareCommand()
        {
            ...
            {
                App.Current.MainPage.DisplayAlert("Messagem", "Selecione um item da lista.", "Ententi");
            }
            else
            {
                ...
                share.Show("Deseja Compartilhar?", texto);
            }
        ...
        private void ExecuteButton()
        {
            if (Desejo.Id >= 1)
            {
                ...
                IniciaDados();
                App.Current.MainPage.DisplayAlert("Messagem", "Editado com sucesso", "OK");
            }
            else
            {
                _conexao.Add(Desejo);
